          ...
          <div className="flex flex-col gap-1.5 mt-2 p-2.5 bg-slate-800/30 border border-slate-750/50 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="flex flex-col gap-1">
                ...
                <input
                  type="number"
                  value={defaultMargins?.top ?? 40}
                  onChange={(e) => setDefaultMargins({ ...defaultMargins, top: parseFloat(e.target.value) || 0 })}
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  type="number"
                  value={defaultMargins?.bottom ?? 50}
                  onChange={(e) => setDefaultMargins({ ...defaultMargins, bottom: parseFloat(e.target.value) || 0 })}
                  className="bg-slate-855 border border-slate-700/80 rounded p-1 text-slate-200 outline-none font-mono"
                />
              </div>
              <div className="flex flex-col gap-1">
            ...
            <span className="text-[9px] text-slate-500 mt-0.5 leading-tight">These will apply to all newly generated pages.</span>
          </div>
              ...
              {selectedPuzzle.specificData.type === "Sudoku" ? (
                ...
                <>
                  ...
                  <button
                    ...
                    disabled={isGenerating}
                    className="bg-emerald-600 hover:bg-emerald-500 disabled:bg-emerald-800 text-white text-xs font-bold py-2 px-3 rounded shadow-md transition-all flex justify-center items-center gap-1.5 active:scale-95 cursor-pointer mt-2"
                  >
                    <Sparkles size={14} className={isGenerating ? "animate-spin" : ""} />
